...
```{r plot1, fig.cap="Plot 1. Scatter plot of simulated damaged data."}
...
```{r plot2, fig.cap="Plot 2. Scatter plot of simulated damaged data."}
damaged_counts$plot
```
...
```{r plot3, fig.cap="Plot 3. Scatter plot of right-skewed simulated damaged data."}
damaged_counts <- simulate_counts(
  count_matrix = test_counts,
...
```{r plot4, fig.width=7, fig.height=4, fig.cap="Plot 4. Scatter plot of damage levels detected."}
